            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 ml-5">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" placeholder="Apellido" name="lastname" value="{{ old('lastname') }}" required autocomplete="lastname" autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 ml-5">
                                <input id="age" type="number" class="form-control @error('age') is-invalid @enderror" placeholder="Edad" name="age" value="{{ old('age') }}" required autocomplete="age" autofocus>
