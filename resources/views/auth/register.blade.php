...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-primary"><b>{{ __('Registro') }}</b></div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 ml-5">
                                    <input id="lastname" type="text"
                                        class="form-control @error('lastname') is-invalid @enderror" placeholder="Apellido"
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 ml-5">
                                    <input id="age" type="number" class="form-control @error('age') is-invalid @enderror"
                                        placeholder="Edad" name="age" value="{{ old('age') }}" required
